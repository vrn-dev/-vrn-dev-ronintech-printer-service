...
var Serial = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                    _this.device.open(function (error) {
                        if (error)
                            throw error;
                        resolve();
                    });
    ...
    Serial.prototype.write = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                    _this.throwIfNeeded();
                    _this.device.write(new Buffer(data), function (err, written) {
                        if (err)
    ...
    Serial.prototype.throwIfNeeded = function (reason) {
        if (!this.device) {
